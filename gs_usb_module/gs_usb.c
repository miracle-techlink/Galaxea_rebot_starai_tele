...
/* HHS USB-CANFD "CANFD Analyser" (candleLight-protocol clone, bulk OUT on EP1) */
#define USB_HHS_CANFD_ANALYSER_VENDOR_ID 0xa8fa
#define USB_HHS_CANFD_ANALYSER_PRODUCT_ID 0x8598

#define GS_USB_ENDPOINT_IN 1
/* NOTE: standard candleLight/gs_usb hardware uses bulk OUT endpoint 2, but the
 * HHS "CANFD Analyser" (a8fa:8598) used with the Galaxea A1Z exposes its bulk
 * OUT on endpoint 1 (0x01) instead. Submitting TX URBs to EP2 on that device
 * fails with -ENOENT and every frame is silently tx_dropped. This build
 * targets that adapter, so OUT is set to endpoint 1. */
#define GS_USB_ENDPOINT_OUT 1
...
static const struct usb_device_id gs_usb_table[] = {
	...
	{ USB_DEVICE_INTERFACE_NUMBER(USB_HHS_CANFD_ANALYSER_VENDOR_ID,
				      USB_HHS_CANFD_ANALYSER_PRODUCT_ID, 0) },
	{} /* Terminating entry */
};
